...
import com.shenxiangxiang.springbootsecuritydemo.model.UserExample.Criteria;
import com.shenxiangxiang.springbootsecuritydemo.model.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getLastLoginAt() != null) {
            sql.VALUES("last_login_at", "#{lastLoginAt,jdbcType=TIMESTAMP}");
        }
        ...
        if (record.getPasswordHash() != null) {
            sql.VALUES("password_hash", "#{passwordHash,jdbcType=BINARY}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getLastLoginAt() != null) {
            sql.SET("last_login_at = #{record.lastLoginAt,jdbcType=TIMESTAMP}");
        }
        ...
        if (record.getPasswordHash() != null) {
            sql.SET("password_hash = #{record.passwordHash,jdbcType=BINARY}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getLastLoginAt() != null) {
            sql.SET("last_login_at = #{lastLoginAt,jdbcType=TIMESTAMP}");
        }
        ...
        if (record.getPasswordHash() != null) {
            sql.SET("password_hash = #{passwordHash,jdbcType=BINARY}");
        }
